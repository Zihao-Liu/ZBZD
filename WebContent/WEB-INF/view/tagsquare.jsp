...
<link href="<%=request.getContextPath() %>/css/tagsquare.css" type="text/css" rel="stylesheet" media="all" charset="utf-8" />
</head>
    ...
    <div class="tagsquare">
        ...
        <ul>
            <c:forEach var="tag" items="${tags}" >
                <li class="toptag"><input type="button" value="${tag.name}" class="but" onclick="window.location.href='/zbzd/tagController/subTag?id=${tag.id}'"/></li>
            </c:forEach>
        </ul>
